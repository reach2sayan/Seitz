...
"""
Raw bindings for Seitz. Import pyseitz instead.
"""
...
class CifStructure:
    ...
    def collapsed(self) -> list[OccupancyCollapse]:
        ...
        """
    @property
    def hall(self) -> pyseitz._core.HallNumber | None:
        """
...
class HallNumber:
    ...
    """
    @staticmethod
    def of(family: GroupFamily, index: typing.SupportsInt | typing.SupportsIndex) -> pyseitz._core.HallNumber | None:
        """
...
class Lattice:
    ...
    """
    @staticmethod
    def from_basis(basis: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"]) -> pyseitz._core.Lattice | None:
        """
...
class Mesh:
    ...
    @staticmethod
    def of(divisions: typing.Annotated[collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], "FixedSize(3)"], shift: typing.Annotated[collections.abc.Sequence[bool], "FixedSize(3)"] = [False, False, False]) -> pyseitz._core.Mesh | None:
        """
...
class SubgroupEdge:
    ...
    def __repr__(self) -> str:
        ...
    def in_subgroup_frame(self, op: SymmetryOperation) -> pyseitz._core.SymmetryOperation | None:
        """
...
class SymmetryAnalyzer:
    ...
    """
    @staticmethod
    def from_cell(cell: Cell, tolerance: Tolerance = ..., setting: pyseitz._core.HallNumber | None = None) -> SymmetryAnalyzer:
        """
...
class SymmetryOperation:
    ...
    def to_xyz(self) -> str:
        ...
        """
    @property
    def inverse(self) -> pyseitz._core.SymmetryOperation | None:
        """
...
class UniNumber:
    ...
    """
    @staticmethod
    def of(number: typing.SupportsInt | typing.SupportsIndex) -> pyseitz._core.UniNumber | None:
        """
...
def conjugated_by(op: SymmetryOperation, t: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"], t_inv: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"]) -> SymmetryOperation:
    ...
    """
def default_hall(family: GroupFamily, number: typing.SupportsInt | typing.SupportsIndex) -> pyseitz._core.HallNumber | None:
    """
...
def halls_with_number(family: GroupFamily, number: typing.SupportsInt | typing.SupportsIndex) -> list[int]:
    ...
    """
def magnetic_operations_from_database(uni: UniNumber, hall: pyseitz._core.HallNumber | None = None) -> MagneticOperations:
    """
...
def magnetic_spacegroup_type(uni: UniNumber) -> MagneticSpacegroupType:
    ...
    """
def magnetic_std_transformations(uni: UniNumber, hall: pyseitz._core.HallNumber | None = None) -> Operations:
    """
