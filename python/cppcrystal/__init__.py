...
fallible call raises a :class:`~cppcrystal.errors.CppCrystalError` subclass, and
...
from .errors import CppCrystalError
...
def analyze(
    ...
    *,
    ...
    This is the single place a validated :class:`~cppcrystal.options.Tolerance`
