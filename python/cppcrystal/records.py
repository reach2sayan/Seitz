...
heavyweight handles -- :class:`~cppcrystal.SymmetryAnalyzer`,
:class:`~cppcrystal.SpaceGroup`, :class:`~cppcrystal.Cell` -- stay extension
...
class CellRecord(_Frozen):
    ...
    The explicit adapter rather than making :class:`~cppcrystal.Cell` itself a
