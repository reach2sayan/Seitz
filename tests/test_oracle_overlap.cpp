...
TEST_CASE("a corrupted reference op is rejected", "[oracle][overlap]") {
  ...
  CHECK_FALSE(checker.check_total_overlap(bad.translation, bad.rotation, 1e-5));
}
