...
[[nodiscard]] bool is_overlap(Vector3d const &a, Vector3d const &b,
                              Matrix3d const &lattice, double symprec) noexcept;

[[nodiscard]] inline bool is_overlap_same_type(Vector3d const &a,
                                               Vector3d const &b, int type_a,
                                               int type_b,
                                               Matrix3d const &lattice,
                                               double symprec) noexcept {
  return type_a == type_b && is_overlap(a, b, lattice, symprec);
}
