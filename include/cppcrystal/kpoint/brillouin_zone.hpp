...
// Brillouin-zone relocation of a reciprocal sampling grid. Each grid point is
// moved to the reciprocal-lattice image closest to the origin; points on a BZ
// boundary (multiple equidistant images within tolerance) are duplicated. The
// map is indexed on the doubled mesh (bzmesh = 2*mesh).
